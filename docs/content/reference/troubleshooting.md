...
Most of these come down to network reality or how bluesky serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

bluesky rate-limits like any public site. bsky already paces
...
Where a surface is gated, bsky reads a cookie or token you supply
...
`bsky`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what bsky actually did
